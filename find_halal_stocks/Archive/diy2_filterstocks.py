...
# Fetch the data that we're going to parse, using the requests headers defined above
...
print(tree.xpath("//h1/@data-reactid"))

table_rows = tree.xpath("//div[contains(@class, 'D(tbr)')]")

# Ensure that some table rows are found; if none are found, then it's possible that Yahoo Finance
# has changed their page layout, or have detected that you're scraping the page
